    ...
    return (
      <div id="main">
        <ol>
             ...
             <li key="location2">{this.cityList[1].name}</li>
             <li key="location3">{this.cityList[2].name}</li>
             <li key="location4">{this.cityList[3].name}</li>
             <li key="location5">{this.cityList[4].name}</li>
             <li key="location6">{this.cityList[5].name}</li>
